...
class TestExtend(unittest.TestCase):
    ...
    def test_add_8_and_9_is_not_5(self):
        self.assertEqual(extend.add(8, 9), 17)
    ...
    def test_max_of_three_is_not_ok(self):
        self.assertEqual(extend.max_of_three(10, 1, 15), 15)

    def test_max_of_three_is_not_ok(self):
        self.assertEqual(extend.max_of_three(10, 100, 15), 100)
